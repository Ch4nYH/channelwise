...
class RolloutStorage(object):
    def __init__(self, num_steps, num_channel, obs_shape, action_shape=1, hidden_size=1, num_recurrent_layers=1):
    ...
    def after_update(self):
        ...
        self.recurrent_hidden_states[0] = self.recurrent_hidden_states[0].detach()
